        ...
        <Box className="markdown" sx={{
            ...
            <ReactMarkdown
                ...
                components={{
                    ...
                    th: ({children}) => (
                        <th style={{padding: "14px 16px", textAlign: "left", borderBottom: "2px solid #334155"}}>
                            {children}
                        </th>
                    ),
                    td: ({children}) => (
                    ...
                    tr: ({children, isHeader}) => (
                        <tr style={{
                            backgroundColor: isHeader ? undefined : "rgba(255,255,255,0.03)",
